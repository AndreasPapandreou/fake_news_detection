...
def fhan3_pretrain(MAX_NB_WORDS, MAX_WORDS, MAX_SENTS, EMBEDDING_DIM, WORDGRU, embedding_matrix, DROPOUTPER, learning_rate):
    ...
    wordEncoder.load_weights('han1Results/weights.h5', by_name=True)
    # -----------------------------------------------------------------------------------------------
